...
function consoleEvent(msg) {
    return __awaiter(this, void 0, void 0, function () {
        var resolvedArgs;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(logLevels.indexOf(msg.type()) >= 0)) return [3 /*break*/, 2];
                    return [4 /*yield*/, Promise.all(msg.args().map(function (arg) { return arg.jsonValue(); }))];
                case 1:
                    resolvedArgs = _a.sent();
                    console[msg.type()].apply(console, resolvedArgs);
                    _a.label = 2;

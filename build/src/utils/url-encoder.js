...
var EMAIL_PROTOCOL = "mailto:";
export var getCurrentProtocol = function (s) {
...
export var removeProtocolHttp = function (s) {
    var res = s;
    if (s.startsWith(HTTP_PROTOCOL)) {
...
export var urlHasEmailProtocol = function (string) {
    var url;
    try {
        url = new URL(string);
    }

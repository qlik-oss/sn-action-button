...
import { colorOptions, fontFamilyOptions, sizeBehaviorOptions, toggleOptions } from "./utils/style-utils";
export var getStyleEditorDefinition = function () { return ({
    items: {
        labelSection: {
                ...
                labelItem: {
                    items: {
                        ...
                        fontSize: {
                            ...
                            step: 0.01,
                            defaultValue: 0.5,
                            show: function (data) { return !(propertyResolver.getValue(data, "style.font.sizeBehavior") === "fixed"); },
                        },
                        fontSizeFixed: {
                            type: "number",
                    ...
                    items: {
                        backgroundImageMode: {
                            ...
                            change: function (data) {
                                var bgImageComp = data.style.background;
                                if (!bgImageComp)
                                    data.style.background = { qStaticContentUrlDef: {} };
                                if (!bgImageComp.url)
                        ...
                        MediaLibrary: {
                            ...
                            translation: "MediaLibrary.Header",
                            show: function (data) { return propertyResolver.getValue(data, "style.background.mode") === "media"; },
                        },
                        imageSize: {
                            component: "dropdown",
                            ...
                            show: function (data) {
                                return propertyResolver.getValue(data, "style.background.mode") === "media" &&
...
export var getStylingPanelDefinition = function () { return ({
    type: "items",
    grouped: false,
    translation: "properties.presentation",
    items: {
        styleEditor: __assign({ component: "styling-panel", chartTitle: "Object.ActionButton", translation: "LayerStyleEditor.component.styling", subtitle: "LayerStyleEditor.component.styling", ref: "components", useGeneral: true, useBackground: true }, getStyleEditorDefinition()),
    },
}); };

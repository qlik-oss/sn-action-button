...
export const createSnackbar = (msg, automationOpenLinkSameWindow, error) => {
  ...
  <button tabindex="-1" style="background:transparent;border:none;">  
  ${error ? 
    ...
    url
      ? `<a href="${getUrl(url)}" style="margin-left: 6px;" tabindex="0" target="${getTarget(automationOpenLinkSameWindow)}">${
          urlText || 'Open'
        }</a>`
      : ''
  }</span>
    <button tabindex="0" class="sn-action-button-snackbar-close" style="background:transparent;border:none;cursor:pointer;">
